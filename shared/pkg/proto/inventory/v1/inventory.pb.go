...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x0fCATEGORY_SHIELD\x10\x052\xdb\x01\n" +
	"\x10InventoryService\x12c\n" +
	"\aGetPart\x12\x1c.inventory.v1.GetPartRequest\x1a\x1d.inventory.v1.GetPartResponse\"\x1b\x82\xd3\xe4\x93\x02\x15\x12\x13/api/v1/part/{uuid}\x12b\n" +
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponse\"\x14\x82\xd3\xe4\x93\x02\x0e\x12\f/api/v1/partBPZNgithub.com/Medeveddo/rocket-science/shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
