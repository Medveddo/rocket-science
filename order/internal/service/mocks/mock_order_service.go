...
func (_m *OrderService) CreateOrder(ctx context.Context, order model.CreateOrderRequest) (model.CreateOrderResponse, error) {
...
func (_m *OrderService) PayOrder(ctx context.Context, request model.PayOrderRequest) (model.PayOrderResponse, error) {
...
func (_c *OrderService_PayOrder_Call) Run(run func(ctx context.Context, request model.PayOrderRequest)) *OrderService_PayOrder_Call {
	_c.Call.Run(func(args mock.Arguments) {
